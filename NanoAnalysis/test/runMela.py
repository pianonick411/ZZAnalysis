...
###################################################################################
...
elif SampleToRun == "ZH_MELA_Test": 
    setConf("SAMPLENAME", "ZH125")
    setConf("LEPTON_SETUP", 2022)  
    setConf("XSEC", 1*0.0002745)
    setConf("IsMC", True)
    setConf("ADD_ALLEVENTS", True)
    setConf("NANOVERSION", 15)
    setConf("store", "")
    setConf("fileNames", ["/eos/user/n/nipinto/old_CMSSW_13_3_3/src/ZH_HZZ_NANO.root"])
    setConf("APPLYJETCORR", False)
    setConf("probabilities",  {
                            "Name": "Native",
                            "Process": "SelfDefine_spin0",
                            "Production": "ZZIndependent",
                            "MatrixElement": "JHUGen",
                            "Couplings": {
                                "ghz1": [
                                    1.0,
    ...
    setConf("probabilities",  {
                            "Name": "p_Gen_Dec_SIG_ghz4_1_JHUGen",
                            "Process": "SelfDefine_spin0",
                            "Production": "ZZIndependent",
                            "MatrixElement": "JHUGen",
                            "Couplings": {
